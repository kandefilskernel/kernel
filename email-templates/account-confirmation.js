...
export const confirmEmailAddress = async (user) => {
	...
	const data = {
		to: user.email,
		from: "Etudies Online Courses <hello@hibootstrap.com>",
                        ...
                        <tr>
                            <td>
                                <div class="text" style="padding: 0 2.5em; text-align: left;">
                                    ...
                                    <p>Thanks for registering on the Etudies! Please click the below link to verify your email address and activate your account.</p>
                                    ...
                                    <p>
                                        Regards, <br />
                                        Etudies Support Team <br />
                                        All Rights Reserved by Etudies.com
                                    </p>
                                </div>
                            </td>
                        </tr>
                          ...
                          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                              ...
                              <p style="text-align: center; margin-bottom: 0; margin-top: 5px">
                                  <a href="http://Etudies.com/" target="_blank" style="color: #3056de">www.Etudies.com</a>
                              </p>
                              </td>
                            </tr>
                          </table>
