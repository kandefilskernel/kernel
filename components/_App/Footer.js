	...
	return (
		<>
						...
						<div className="col-lg-3 col-sm-6">
							<div className="single-footer-widget">
								...
								<ul className="info">
									...
									<li>
										<span>Address:</span> +7011 Front street,
										Toronto, ON M4S 1E3
									</li>
									<li>
										<span>Mail Us:</span>{" "}
										<a href="mailto:hello@etudies.com">
											hello@etudies.com
										</a>
									</li>
								</ul>
			...
			<div className="copy-right-area bg-color-f6fafb">
				<div className="container">
					<p>
						&copy; Etudies {currentYear} is Proudly Owned by{" "}
						<a href="https://astech.com/" target="_blank">
							Asymptote Technology
						</a>
					</p>
				</div>
			</div>
